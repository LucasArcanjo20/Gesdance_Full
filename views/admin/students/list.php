                                    ...
                                    <?php if (count($list_student) != 0) : ?>
                                        <?php foreach ($list_student as $key => $items) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?= BASE_URL; ?><?= $items['image_voice_authorization_attachment']; ?>" target="_blank" download class="btn btn-success btn-sm">Anexos</a>
                                                <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal" title="Adicionar Turma" onclick="modalStudentId(<?= $items['id']; ?>)"><i class="fa fa-users" aria-hidden="true"></i></a>
