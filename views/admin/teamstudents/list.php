                                        ...
                                        <?php foreach ($list as $key => $items) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= BASE_URL; ?>Student/destroy/<?= $items['id']; ?>" onclick="return confirm('Deseja realmente excluir esse Professor?');"><button type="button" class="btn btn-danger btn-sm" title="Deletar"><i class="ti-trash"></i></button></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
