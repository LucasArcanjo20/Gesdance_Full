        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="<?= BASE_URL; ?>Teacher/update/<?= $info["id"]; ?>" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone" id="phone" required="" value="<?= $info["phone"]; ?>">
                                        </div>
                                    </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="zipcode" id="zipcode"
                                                required=""  onchange="pesquisacep(this.value)" value="<?= $info["zipcode"]; ?>" >
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <select class="form-control " data-placeholder="Select" name="state" id="state"
                                            onchange="muda_estado();" value="<?= $info["state"]; ?>">
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <select class="form-control " data-placeholder="Select" name="city" id="city"
                                            onchange="muda_cidade();" value="<?= $info["city"]; ?>">
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required="" name="reference"
                                                id="reference" value="<?= $info["reference"]; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control" aria-label="Tipos-de-dança"  name="descrition" id="descrition" value="<?= $info["descrition"]; ?>"></textarea>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 ">
                                        ...
                                        <input type="text" class="form-control" name="instagram" id="instagram" required="" value="<?= $info["instagram"]; ?>">
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 ">
                                        ...
                                        <input type="text" class="form-control" name="image" id="image" required=""value="<?= $info["document"]; ?>">
                                    </div>

                                    <div class="col-lg-6 col-md-6 ">

                                        <label for="date_birth">Data de Nascimento: (*)</label>
                                        <input type="date" class="form-control" name="date_birth" id="date_birth" required=""value="<?= $info["date_birth"]; ?>">
                                    </div>
